...
<div class="container">
    ...
    <form action="<?= base_url("Save") ?>" method="post">
        ...
        <select id="StudCourse" name="StudCourse" required>
            <option value=" " <?= isset($d['StudCourse']) && $d['StudCourse'] === '' ? 'selected' : '' ?>></option>
            <option value="BSIT" <?= isset($d['StudCourse']) && $d['StudCourse'] === 'BSIT' ? 'selected' : '' ?>>BSIT</option>
            <option value="BSCRIM" <?= isset($d['StudCourse']) && $d['StudCourse'] === 'BSCRIM' ? 'selected' : '' ?>>BSCRIM</option>
            <option value="BSHM" <?= isset($d['StudCourse']) && $d['StudCourse'] === 'BSHM' ? 'selected' : '' ?>>BSHM</option>
            <option value="BTVTED" <?= isset($d['StudCourse']) && $d['StudCourse'] === 'BTVTED' ? 'selected' : '' ?>>BTVTED</option>
        </select>
